"""
Payment protocol wrapper (seller role) for the Unified Movie Agent.

Follows the same pattern as the stripe-horoscope-agent example:
routes CommitPayment and RejectPayment to handler callbacks.
"""
