...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const text =
      data.content?.[0]?.text || "Sorry, I didn't catch that. Can you repeat?";
...
function getFallbackResponse(
  ...
  if (lastMessage.includes("tell me about") || lastMessage.includes("what brought")) {
  ...
  if (lastMessage.includes("husband") || lastMessage.includes("spouse") || lastMessage.includes("partner")) {
  ...
  if (lastMessage.includes("guarantee") || lastMessage.includes("work for me") || lastMessage.includes("results")) {
